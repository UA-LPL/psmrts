...
namespace psmrts::bullet {
   ...
   */
  btScalar PsmrtsBulletClosestRayCallback::distance() const {
   ...
   */
  btScalar PsmrtsBulletClosestRayCallback::distance(const PsmrtsBulletClosestRayCallback &other) const {
   ...
   */
  btScalar PsmrtsBulletClosestRayCallback::distance(const btVector3 &other) const {
    if ( !isValid() ) return (DBL_MAX);
   ...
   */
  bool PsmrtsBulletClosestRayCallback::operator==(const PsmrtsBulletClosestRayCallback &other) const {
   ...
   */
  const void *PsmrtsBulletClosestRayCallback::body() const {
    if ( !isValid() ) return (0);
