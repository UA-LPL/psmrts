...
public:
    ...
    /**
     * @brief  Parse from a raw string (e.g. already-read file contents).
     * 
     * @returns the number of Group/Object blocks found.
     */
    ...
    /**
     * @brief Get group whose name matches parameter
     *
     ...
     * 
     * @returns matching group, or empty if no match
     */
    ...
    /**
     * @brief Return ALL blocks whose group name matches (case-insensitive).
     * 
     * Useful when the same group name appears more than once in a file.
     * 
     * @returns vector containning all matching blocks
     */
    ...
    /**
     * @brief Look up a single value by group name + key (both case-insensitive).
     * 
    ...
    /**
     * @brief Look up a single value with a fallback default.
     * 
     * @param group_name  group name
     * @param key         key name 
     * @param default_val default value if not found
     * @returns           string representation of found or default value
     */
    ...
    /**
     * @brief The translation table populated from all parsed key/value pairs.
     * 
     ...
     * 
     * @returns PsmrtsTranslation containing parsed data
     */
    ...
    /**
     * @brief Serialize all parsed blocks back to ISIS PVL format.
     *
    ...
    /**
     * @brief Serialize all parsed blocks to a flat "Key = Value" format,
    ...
    /**
     * @brief Write the flat "Key = Value" serialization to a file.
     *
     * @param filename  Path to the output file (created or overwritten).
     * @throws std::runtime_error if the file cannot be opened for writing.
     */
...
private:
    ...
    /** The four ISIS tag pairs we register with PsmrtsTagSearch. */
    ...
    /**
     * @brief Block creation and conversion function
     * 
    ...
    /**
     * @brief Extract the group/object name from the captured body.
     *
    ...
    /**
     * @brief Parse key = value pairs from a captured body into a KVMap.
     *
