...
TEST_CASE( "C api Test Suite", "[capi][introduction]") {

  auto version = test_version;
  // spdlog::info("PSMRTS c api Catch Test Suite version {}", version );
  INFO("PSMRTS capi Catch Test Suite version " << test_version);
