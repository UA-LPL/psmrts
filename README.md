...
The [Doxygen](https://www.doxygen.nl/index.html) configuration file, Doxyfile, is located in the docs directory. To access the documentation the -D tag is required when executing ./make_psmrts.sh, then requires the following commands:
