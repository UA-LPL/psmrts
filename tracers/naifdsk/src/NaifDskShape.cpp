...
#define SAVE_LATLON_INTERCEPT 1
   ...
   *
   */
  double NaifDskShape::emissionAngle(const std::vector<double> &observerBodyFixedPosition) {
   ...
   */
  double NaifDskShape::incidenceAngle(const std::vector<double> &illuminatorBodyFixedPosition) {
