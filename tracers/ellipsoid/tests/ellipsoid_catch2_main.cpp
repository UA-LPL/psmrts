...
TEST_CASE( "ellipsoid test suite", "[ellipsoid][introduction]") {

  auto version = test_version;
  // spdlog::info("ellipsoid Catch Test Suite version {}", version );
  INFO("ellipsoid Catch Test Suite version " << test_version);
