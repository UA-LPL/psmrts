...
TEST_CASE( "PSMRTS Factory Docs Example", "[factory][docs][example]") {
  ...
  factory1.liquidate();  // Start with empty factory
   ...
   CHECK( factory1.get_inventory_list() == std::vector<std::string>( { "inv1", "inv2", "psmrts" } ) );
