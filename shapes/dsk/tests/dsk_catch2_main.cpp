...
TEST_CASE( "DSK Format Test Suite", "[dsk][introduction]") {

    auto version = test_version;
    // spdlog::info("DSK Format Catch Test Suite version {}", version );
    INFO("DSK Format Catch Test Suite version " << test_version);
