...
TEST_CASE( "OBJ Format test suite", "[obj][introduction]") {

  auto version = test_version;
  // spdlog::info("OBJ Formay Catch Test Suite version {}", version );
  INFO("OBJ Format Catch Test Suite version " << test_version);
