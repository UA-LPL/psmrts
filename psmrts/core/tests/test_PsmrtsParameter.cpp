...
TEST_CASE ( "PsmrtsParameter Parameter Tests", "[parameter][json]") {
  ...
  CHECK( double_c.type() == psmrts::PsmrtsParameter::PsmrtsDoubleArray );
...
TEST_CASE( "PsmrtsParameter Parameter Values Tests", "[parameter][values]") {
  ...
  CHECK(boolval.type()  == psmrts::PsmrtsParameter::PsmrtsBoolean);
  ...
  CHECK(intval.type()  == psmrts::PsmrtsParameter::PsmrtsInteger);
  CHECK(intval.size()  == 1 );
  ...
  CHECK(dblval.type()  == psmrts::PsmrtsParameter::PsmrtsDouble);
  CHECK(dblval.size()  == 1 );
  ...
  CHECK(strval.type()  == psmrts::PsmrtsParameter::PsmrtsString);
  CHECK(strval.size()  == 1 );
  ...
  CHECK(intvec.type()  == psmrts::PsmrtsParameter::PsmrtsIntegerArray);
  CHECK(intvec.size()  == 3 );
  ...
  CHECK(dblvec.type()  == psmrts::PsmrtsParameter::PsmrtsDoubleArray);
  CHECK(dblvec.size()  == 3 );
  ...
  CHECK(strvec.type()  == psmrts::PsmrtsParameter::PsmrtsStringArray);
  CHECK(strvec.size()  == 3 );
  ...
  CHECK(jsonvec.type()  == psmrts::PsmrtsParameter::PsmrtsJsonObject);
  ...
  CHECK(v3dvec.type()  == psmrts::PsmrtsParameter::PsmrtsDoubleArray);
  CHECK(v3dvec.size()  == 3 );
  ...
  CHECK(v3ivec.type()  == psmrts::PsmrtsParameter::PsmrtsIntegerArray);
  CHECK(v3ivec.size()  == 3 );
